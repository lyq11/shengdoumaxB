  ...
  <div id="app">
      ...
      <div class="bottom clearf">
        ...
        <div class="botList fl">
          <div class="listTop clearf">
            <div class="lTitle fl">|||</div>
            <div class="title fl">是否打开</div>
            <div class="rTitle fr">|||</div>
          </div>
          <div class="echartsC detail">
            <div class="isOpen">井盖是否打开：{{isopen}}</div>
            <img src="../assets/img/isOpenT.png" alt="" class="isOpenImg">
          </div>
        </div>
        <div class="botList fl">
          <div class="listTop clearf">
            <div class="lTitle fl">|||</div>
            <div class="title fl">是否开锁</div>
            <div class="rTitle fr">|||</div>
          </div>
          <div class="echartsC detail">
            <div class="isOpen">设备是否开锁：{{islock}}</div>
            <img src="../assets/img/isLockT.png" alt="" class="isOpenImg">
          </div>
        </div>
      </div>
  </div>
...
import deviceSignal from '@/components/deviceSignal'
export default {
  data () {
    return {
      isopen: '打开',
